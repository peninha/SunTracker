...
function PrayTimes(method) {
	...
	*/
	...
	sunHorizontPosition: function(jd, coords, UTC) {
		var D = jd - 2451545.0;
		var g = DMath.fixAngle(357.529 + 0.98560028* D);
		var q = DMath.fixAngle(280.459 + 0.98564736* D);
		var L = DMath.fixAngle(q + 1.915* DMath.sin(g) + 0.020* DMath.sin(2*g));
...
var jd = PT.julian(2019, 05, 03);
jd = 2458606.89375; // UTC 9 27 = 6 27 BR
jd = 2458607; //UTC 12:00

jd = 2458677.78125;
//var coordinates = [-23.533773, -46.625290, 760];
var coordinates = [-23.532477, -46.6585597, 760];
var coordinates = [0,0,0];

var coordinates = [47.8027248, 12.91634680, 0];

var times = PT.getTimes(new Date(), coordinates, 0);
document.write('Sunrise = '+ times.sunrise);
document.write('<BR>');
document.write('Sunset = '+ times.sunset);
document.write('<BR>');
document.write('<BR>');
var sun = PT.sunHorizontPosition(jd, coordinates);
document.write('sun RA = '+ sun.RA);
document.write('<BR>');
var RAhour = degreeDec2Hour(sun.RA);
document.write('sun RA Hour = '+ RAhour.hour +' Min = '+ RAhour.min +' Sec = '+ RAhour.sec);

document.write('<BR>');
document.write('sun Declinacao = '+ sun.Declination);
document.write('<BR>');
var DeclArc = degreeDec2Arc(sun.Declination);
document.write('sun Decli Degree = '+ DeclArc.degree +' Min = '+ DeclArc.min +' Sec = '+ DeclArc.sec);
document.write('<BR>');
document.write('<BR>');
